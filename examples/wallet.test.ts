...
import {Wallet, Wasm, Kiwi} from '@kasplex/kiwi';
...
describe('wallet  function tests', () => {
    ...
    it('Wallet fromMnemonic with create an new derive path wallet', () => {
        ...
        const address1 = wallet1.toAddress(Wasm.NetworkType.Testnet);
        ...
        const address2 = wallet2.toAddress(Wasm.NetworkType.Testnet);
    ...
    it('test validate address', async () => {
        ...
        let add = new Wasm.PublicKey("02b94904c8a44321a8b116e947429b6b83f9091887888288cd70c3a7a8655408d4").toAddress(Kiwi.network).toString()
        console.log("add", add)
    })
});
