...
describe('wallet  function tests', () => {
    ...
    test('Wallet fromMnemonic without password', () => {
    ...
    test('Wallet fromMnemonic with password', () => {
        const mnemonicStr = "struggle glare pigeon shine fire cargo offer venture luxury jeans clean initial";
    ...
    test('Wallet fromMnemonic with create an new derive path wallet', () => {
        const mnemonicStr = "struggle glare pigeon shine fire cargo offer venture luxury jeans clean initial";
    ...
    test('test validate address', async () => {
