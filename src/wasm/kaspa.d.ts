 ...
 * the storage folder will default to `~/.kaspa-web`
...
interface IGeneratorSettingsObject {
     ...
     * 
     * Typical usage: { address: "kaspa-web:...", amount: 1000n }
     */
...
* with the default filename `kaspa-web`.
*
* @category Wallet API
*/
...
export interface IPaymentOutput {
     ...
     * you are transacting on (e.g. `kaspa-web:` for mainnet, `kaspatest:` for testnet, etc).
     */
    address: Address | string;
    /**
...
/**
 * Kaspa [`Address`] struct that serializes to and from an address format string: `kaspa-web:qz0s...t8cv`.
 *
 * @category Address
 */
 ...
 *     utxoEntries : [...],
 *     changeAddress : "kaspa-web:...",
 *     outputs : [
 *         { amount : kaspaToSompi(10.0), address: "kaspa-web:..."},
 *         { amount : kaspaToSompi(20.0), address: "kaspa-web:..."},
 *         ...
 *     ],
 *     priorityFee : 1000n,
 * });
...
/**
 *
 * NetworkId is a unique identifier for a kaspa-web network instance.
...
export interface InitOutput {
  ...
  readonly __wbindgen_export_15: (a: number, b: number, c: number, d: number) => number;
  readonly __wbindgen_export_16: (a: number, b: number, c: number) => void;
  readonly __wbindgen_export_17: (a: number, b: number) => void;
