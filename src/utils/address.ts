import {AddressVersion, AddressPrefix} from '../utils/enum';
import { Wasm } from "../index";
import {networkToAddressPrefix, addressPrefixToNetwork, stringToAddressPrefix} from '../utils/utils';
...
export class Address {
     ...
     */
    public static toAddress(network: Wasm.NetworkType, version: AddressVersion, payload: Uint8Array): string {
