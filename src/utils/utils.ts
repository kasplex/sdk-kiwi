 ...
 */
function networkToString(networkType: Wasm.NetworkType): string {
    switch (networkType) {
        case Wasm.NetworkType.Mainnet:
            return "mainnet";
        case Wasm.NetworkType.Testnet:
            return "testnet-10";
        case Wasm.NetworkType.Devnet:
            return "devnet";
        default:
...
function addressPrefixToNetwork(network: AddressPrefix): Wasm.NetworkType {
    switch (network) {
        case AddressPrefix.Mainnet:
            return Wasm.NetworkType.Mainnet;
        case AddressPrefix.Testnet:
            return Wasm.NetworkType.Testnet;
        default:
...
function networkToAddressPrefix(network: Wasm.NetworkType): AddressPrefix {
    switch (network) {
        case Wasm.NetworkType.Mainnet:
