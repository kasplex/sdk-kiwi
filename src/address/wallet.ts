...
class Wallet {
    private privateKey: Wasm.PrivateKey;
    private walletType?: WalletType;
    private xprv?: Wasm.XPrv;
     ...
     */
    private constructor(privateKey: Wasm.PrivateKey, walletType?: WalletType, xprv?: Wasm.XPrv, index?: number) {
    ...
    public static fromPrivateKey(privateKey: string): Wallet {
        return new Wallet(new Wasm.PrivateKey(privateKey), WalletType.PrivateKey);
    }
     ...
     */
    public toPublicKey(): Wasm.PublicKey {
     ...
     */
    public toXOnlyPublicKey(): Wasm.XOnlyPublicKey {
     ...
     */
    public toAddress(network: Wasm.NetworkType): Wasm.Address {
     ...
     */
    public signMessage(message: string): Wasm.HexString {
        return Wasm.signMessage({
            message: message,
